...
function Home({ exploreData,LCardData }) {
  console.log("LCardData",LCardData);
  return (
    <div>
      <Head>
      ...
      <main className="max-w-6xl mx-auto px-8 sm:px-16">
        ...
        <section>
          <h2 className="text-2xl font-semibold by-3 pl-3">Live Anywhere</h2>
...
export async function getStaticProps() {
 ...
 const LCardData= await fetch('https://json.extendsclass.com/bin/4f46e2df5a67').then(res=>res.json())
  return {
    props: {
      exploreData,LCardData
    },
  };
}
